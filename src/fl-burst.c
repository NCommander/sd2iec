/* sd2iec - SD/MMC to Commodore serial bus interface/controller
   ...
   Fast Serial ported forward to SD2IEC by:
   Copyright (c) 2021 Michael Casadevall <michael@casadevall.pro>
   ...
   fl-burst.c: 1571 Burst Serial Mode Support
