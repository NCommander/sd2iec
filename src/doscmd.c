...
static void parse_user(void) {
  ...
  case '0':
    ...
    case 0x1a:
    {
      ...
      do
      {                                               /* send results, break if ATN found */
...
void parse_doscommand(void) {
  ...
  if (command_length < 2 || command_buffer[0] != 0x55 || command_buffer[1] != 0x30)
  {
